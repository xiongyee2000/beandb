...
TEST(BeanWorld, removeBean)
{
    ...
    world.removeBean(bean2->getId());
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.r1) == 0);
    ...
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.r1) == bean3->getId());
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.r2) == bean3->getId());
    EXPECT_TRUE(bean2->getRelationBeanId(testHelper.r1) == bean3->getId());
    EXPECT_TRUE(bean2->getRelationBeanId(testHelper.r2) == bean3->getId());
    world.removeBean(bean3->getId());
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.r1) == 0);
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.r2) == 0);
    EXPECT_TRUE(bean2->getRelationBeanId(testHelper.r1) == 0);
    EXPECT_TRUE(bean2->getRelationBeanId(testHelper.r2) == 0);
    ...
    bean1->appendRelation(testHelper.rArray_1, bean4);
    ...
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.rArray_1, 1) == bean4->getId());
    ...
    world.removeBean(bean3->getId());
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.rArray_1, 0) == bean4->getId());
    ...
    bean2->appendRelation(testHelper.rArray_1, bean4);
    bean2->appendRelation(testHelper.rArray_2, bean4);
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.rArray_1, 0) == bean4->getId());
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.rArray_2, 0) == bean4->getId());
    EXPECT_TRUE(bean2->getRelationBeanId(testHelper.rArray_1, 0) == bean4->getId());
    EXPECT_TRUE(bean2->getRelationBeanId(testHelper.rArray_2, 0) == bean4->getId());
    world.removeBean(bean4->getId());
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.rArray_1, 0) == 0);
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.rArray_2, 0) == 0);
    EXPECT_TRUE(bean2->getRelationBeanId(testHelper.rArray_1, 0) == 0);
    ...
    EXPECT_TRUE(bean2->getRelationBeanId(testHelper.rArray_1, 0) == bean3->getId());
        EXPECT_TRUE(bean3->m_subjectMap_.size() == 1);
    world.removeBean(bean2->getId());
    EXPECT_TRUE(bean1->getRelationBeanId(testHelper.rArray_1, 0) == 0);
    EXPECT_TRUE(bean3->m_subjectMap_.size() == 0);
